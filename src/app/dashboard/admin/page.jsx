      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {[
          ...
          },
          {
            ...
            border: lowStockItemsCount > 0 ? "border-rose-500/50 text-rose-300 animate-pulse" : "border-slate-500/15"
          }
        ].map((stat, i) => (
        ...
        <div className="lg:col-span-5 rounded-2xl border border-white/5 bg-slate-900/40 p-6 backdrop-blur-md">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link
              ...
              className="p-4 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.06] text-left transition-all duration-300 cursor-pointer block"
            >
