  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-2xl shadow-sm">
        <div>
          <h3 className="text-sm font-bold text-slate-950 dark:text-white">Student Progress & Learning Metrics</h3>
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
              <span className="w-52 text-xs font-medium text-slate-700 dark:text-slate-300">{bar.metric}</span>
              ...
              <span className="w-12 text-right text-xs font-mono font-bold text-slate-800 dark:text-white mt-1 sm:mt-0">{bar.pct}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4 mb-5">
          ...
          <span className="text-xs font-mono font-bold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-white/5 px-2.5 py-1 rounded-lg">
            ...
            <div 
              ...
              className={`p-3 rounded-xl border text-center flex flex-col items-center justify-center gap-2 transition-all ${
                attended 
                  ...
                  : "bg-slate-50 dark:bg-slate-950/40 border-slate-150 dark:border-slate-800/80 text-slate-400 dark:text-slate-500"
              }`}
            >
              <span className="text-[9px] uppercase font-bold tracking-widest font-mono">Class {i + 1}</span>
              {attended ? (
                <div className="w-5 h-5 rounded-full bg-emerald-100 dark:bg-emerald-500/20 flex items-center justify-center border border-emerald-200 dark:border-emerald-500/30">
                ...
                <div className="w-5 h-5 rounded-full bg-slate-200 dark:bg-slate-900 flex items-center justify-center border border-slate-350 dark:border-white/5">
