...
export const Sidebar = ({ role }) => {
  ...
  const menuConfig = {
    admin: [
      ...
      { name: "Franchises", href: "/dashboard/admin/franchise", icon: Users },
      { name: "Global Inventory", href: "/dashboard/admin/inventory", icon: Box },
    ],
    franchise: [
      { name: "Overview", href: "/dashboard/franchise", icon: LayoutDashboard },
      { name: "Students", href: "/dashboard/franchise/students", icon: Users },
      { name: "Teachers", href: "/dashboard/franchise/teachers", icon: UserCheck },
      { name: "Batches", href: "/dashboard/franchise/batches", icon: BookOpen },
    ...
    teacher: [
      ...
      { name: "Exams", href: "/dashboard/teacher/exams", icon: Award },
      { name: "Progress Board", href: "/dashboard/teacher/progress", icon: Box },
    ],
    student: [
      { name: "My Progress", href: "/dashboard/student", icon: LayoutDashboard },
      { name: "Attendance View", href: "/dashboard/student/attendance", icon: UserCheck },
      { name: "Exam Section", href: "/dashboard/student/exams", icon: Award },
